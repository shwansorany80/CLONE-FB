...
def chk():
  ...
  try: 
    ...
    httpCaht = requests.get("https://raw.githubusercontent.com/THANATOS4545/thx/main/id.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m BO ID ACTIVE KRDN @i4m_THNS") 

      os.system('xdg-open  https://t.me/i4m_THNS')
...
def menu(n,t):
	...
	elif ask in ['3','03']:os.system("python2 rnd.py")
	elif ask in ['4','04']:os.system("python FILE.py")
